...
<div class="flex flex-row h-screen pt-15" style="background-color: #00000066">
		...
		<div class="h-full px-3 py-4 overflow-y-auto bg-verdigris">
			<ul class="space-y-2 font-medium">
				<li>
					...
					<a id="view-users" href="" class="flex items-center p-2 rounded-lg text-white bg-verdigris dash-sidebar-item">
	...
	<div class="h-full w-full p-5 shadow-md">
		<div class="flex flex-col h-full w-full items-center bg-white rounded-md overflow-y-auto">
